...
namespace FastCsvParser.Tests
{
    public class CsvParserTests
    {
        ...
        // Tests for ParseLineSpan method

        [Fact]
        public void ParseLineSpan_SimpleString_ReturnsCorrectFields()
        {
            string input = "John,Doe,30,USA";
        ...
        [Fact]
        public void ParseLineSpan_WithQuotes_RemovesQuotes()
        {
            string input = "John,Doe,30,USA,\"Programmer\"";
        ...
        [Fact]
        public void ParseLineSpan_WithCommaInsideQuotes_KeepsField()
        {
            string input = "John,Doe,30,USA,\"Programmer, Driver\"";
        ...
        [Fact]
        public void ParseLineSpan_EmptyFields_ReturnsEmptyStrings()
        {
            string input = "John,Doe,30,,";
        ...
        [Fact]
        public void ParseLineSpan_EmptyField_ReturnsEmptyString()
        {
            string input = "";
        ...
        [Fact]
        public void ParseLineSpan_DoubleQuotes_HandlesEscaping()
        {
            string input = "John,Doe,30,USA,\"Programmer \"\"Seniour\"\"\"";
        ...
        [Fact]
        public void ParseLineSpan_NullInput_ThrowsException()
        {
            string input = null;
